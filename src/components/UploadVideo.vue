                    ...
                    <div class="grid-content bg-white">
                        <el-tabs type="border-card">
                            <el-form :model="ruleForm" :rules="rules" label-width="120px" ref="ruleForm"
                                     v-if="page===0" enctype="multipart/form-data">
                                <el-form-item>
                                </el-form-item>
                                ...
                                <el-form-item label="课程视频" prop="video">
                                    ...
                                    >
                                        ...
                                        <div class="el-upload__text">将视频拖到此处，或<em>点击添加视频</em></div>
                                    </el-upload>
                                </el-form-item>
                                <el-form-item>
        ...
        methods: {
            ...
            async submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        this.uploadVideoForm.upload_time = moment(new Date()).format("YYYY-MM-DD HH:mm:ss");
