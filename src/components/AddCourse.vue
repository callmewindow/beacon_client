                    ...
                    <div class="grid-content bg-white">
                        <el-tabs type="border-card">
                            ...
                            <el-form :model="Form" :rules="rules" ref="Form" label-width="120px" v-if="page===0">
                                    ...
                                    <el-col :span="12">
                                        <el-form-item prop="startTime">
                                            <el-date-picker type="date"
                                                            ...
                                                            placeholder="请选择日期" v-model="Form.startTime"
                                                            style="width: 100%;"
                                    ...
                                    <el-col :span="12">
                                        <el-form-item prop="endTime">
                                            <el-date-picker type="date"
                                                            ...
                                                            placeholder="请选择日期" v-model="Form.endTime"
                                                            style="width: 100%;"
                                                            @change='changeTime'></el-date-picker>
                                        </el-form-item>
                                    </el-col>
                                ...
                                <el-form-item>
                                    <el-button type="primary" @click="submitFormWhole('Form')">添加课程
                                    </el-button>
    ...
    export default {
        ...
        created() {
            ...
            this.endDate = {
                disabledDate: (time) => {
                    return (
                        time.getTime() < this.Form.startTime
                    )
                }
            };
        },
            ...
            submitFormWhole(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        this.courseEntity.start_time = moment(this.Form.startTime).format("YYYY-MM-DD HH:mm:ss");
                        this.courseEntity.end_time = moment(this.Form.endTime).format("YYYY-MM-DD HH:mm:ss");
                        this.uploadPaper();
                    } else {
